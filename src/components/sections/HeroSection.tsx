...
const HeroSection = () => {
  ...
  return (
    <section className="min-h-screen relative flex flex-col justify-center overflow-hidden">
      {/* Logo */}
      <div className="absolute top-6 left-6 md:top-8 md:left-8 lg:top-10 lg:left-12 z-20">
        <Image 
          src="/images/ai-ldn-logo.png" 
          alt="AI Advantage Logo" 
          width={200} 
          height={50} 
          className="h-10 w-auto md:h-12 lg:h-20 transition-all duration-300 hover:opacity-90"
        />
      </div>
